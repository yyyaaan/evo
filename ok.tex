...
\abstract{Innovation has been an active research object in modern business study, while the use complexity analysis is increasingly popular for its systematic view that tackles the real-world complexity in business. This thesis seeks to deepen the understanding of innovation in a complex adaptive system by combining brief qualitative analysis on the complexity of mobile phone industry and further quantitative elaboration with the empirical data of about 8020 mobile phones released to the market in the past two decades. Unsurprisingly, the data from the complex system is statistically complex in terms of data characteristics, and carefully selected proper exploratory approaches is utilized to seek for patterns, behaviors, interdependence and other industrial features in mobile phone industry. Consequently, a hidden feedback loop is proposed based on the findings and finally the relationship between feedback loop, innovation, evolution and co-evolution is established. This exploratory insight suggests that organizational agility and speed to response, instead of efforts in predicting the future, are potentially critical components in a VUCA complex adaptive system.}
\author{Yan Pan}
